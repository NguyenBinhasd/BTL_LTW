...
namespace BTL
{
    public partial class frmDMHangHoa : Form
    {
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            ...
            sql = "INSERT INTO tblHangHoa(MaHang,TenHang,MaChatLieu,SoLuong,DonGiaNhap,DonGiaBan,GhiChu) VALUES(N'"
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            ...
            sql = "UPDATE tblHangHoa SET TenHang=N'" + txtTenHang.Text.Trim().ToString() +
                ...
                "',SoLuong='" + txtSoLuong.Text + "',Ghichu='" + txtGhiChu.Text + "' WHERE MaHang=N'" + txtMaHang.Text + "'";
            Functions.RunSQL(sql);
            LoadDataGridView();
            ResetValues();
            btnBoQua.Enabled = false;
        ...
        {
            string sql;
            sql = "SELECT MaHang,TenHang,MaChatLieu,SoLuong,DonGiaNhap,DonGiaBan,Ghichu FROM tblHangHoa";
            tblH = Functions.GetDataToTable(sql);
            dgvHang.DataSource = tblH;
        }
